...
import { GET_ARTICLES_URL, GET_ARTICLE_DETAIL_URL, ARTICLE_ADD_URL, ARTICLE_UPDATE_URL } from '@/config/api'
...
export {
    GET_ARTICLES, GET_ARTICLE_DETAIL, ARTICLE_ADD, ARTICLE_UPDATE
}